...
*/
        ...
        const scrollers = document.querySelectorAll(".decor-footer");
        if (!window.matchMedia("(prefers-reduced-motion: reduce)").matches) addAnimation();
        function addAnimation() {
            scrollers.forEach((scroller => {
                scroller.setAttribute("data-animated", true);
                const scrollerInner = scroller.querySelector(".decor-footer__row");
        ...
        window.onload = function() {
            let acceptBtn = document.getElementById("acceptCookie");
            let consentDiv = document.getElementById("cookieConsent");
        ...
        sections.forEach((section => {
            const price = section.querySelector(".block-content__price");
            gsapWithCSS.from(price, {
                scrollTrigger: {
                    trigger: price,
                    start: "top 80%",
                    end: "bottom 80%"
        ...
        sections.forEach((section => {
            const lable = section.querySelector(".block-content__lable");
            gsapWithCSS.from(lable, {
                scrollTrigger: {
                    trigger: lable,
                    start: "top 80%",
                    end: "bottom 80%"
        ...
        const slides = document.querySelectorAll(".types__slide");
        slides.forEach(((slide, index) => {
            gsapWithCSS.from(slide, {
                scrollTrigger: {
                    trigger: slide,
                    start: "top 80%",
                    end: "bottom 80%"
        ...
        const recipes = section.querySelectorAll(".col__body");
        recipes.forEach(((recipe, index) => {
            gsapWithCSS.from(recipe, {
                scrollTrigger: {
                    trigger: recipe,
                    start: "top 80%",
                    end: "bottom 80%"
        ...
        const feedbackSlides = feedbackSection.querySelectorAll(".feedback__slide");
        ...
        const script_image = document.querySelector(".philosophy__image img");
        const tl1 = gsapWithCSS.timeline({
            scrollTrigger: {
                trigger: script_image,
                start: "top 80%",
                end: "bottom 80%"
            }
        });
        tl1.from(script_image, {
            duration: 1,
            rotationY: -180,
        ...
        const imageConcept = document.querySelector(".concept__image img");
        const tl2 = gsapWithCSS.timeline({
            scrollTrigger: {
                trigger: imageConcept,
                start: "top 80%",
                end: "bottom 80%"
            }
        });
        tl2.from(imageConcept, {
            duration: 1,
            rotationY: -180,
            transformOrigin: "center"
        }).to(imageConcept, {
        ...
        const imageTreasures = document.querySelector(".treasures__image img");
        const tl3 = gsapWithCSS.timeline({
            scrollTrigger: {
                trigger: imageTreasures,
                start: "top 80%",
                end: "bottom 80%"
            }
        });
        tl3.from(imageTreasures, {
            duration: 1,
            rotationY: -180,
            transformOrigin: "center"
        }).to(imageTreasures, {
        ...
        gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
        const halvaElements = document.querySelectorAll(".halva__content .block-content__body, .halva__content .block-content__image img, .halva__content, .halva__gift");
        halvaElements.forEach(((el, index) => {
            gsapWithCSS.from(el, {
                opacity: 0,
                y: 50,
                delay: index * .2,
        ...
        const assortmentElements = document.querySelectorAll(".assortment__content .block-content__body, .assortment__content .block-content__image img, .assortment__content, .assortment__products");
        assortmentElements.forEach(((el, index) => {
            gsapWithCSS.from(el, {
                opacity: 0,
                y: 50,
                delay: index * .2,
